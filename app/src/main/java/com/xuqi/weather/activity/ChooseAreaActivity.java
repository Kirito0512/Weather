...
import com.xuqi.weather.util.HttpCallbackListener;
import com.xuqi.weather.util.HttpUtil;
...
public class ChooseAreaActivity extends Activity {
    ...
    private void queryFromServer(final String code,final String type) {
        ...
        if(!TextUtils.isEmpty(code)){
            ...
            Log.d(TAG, "从服务器查询 address = "+address);
        }else{
            address = "http://www.weather.com.cn/data/list3/city.xml";
        }
        showProgressDialog();

        //sendHttpRequest中开启了子线程，子线程中无法进行UI操作，所以使用runOnUiThread()
    ...
    /*
    补货Back按键，根据当前级别来判断，此时应该返回市列表，省列表，还是直接退出
     */
